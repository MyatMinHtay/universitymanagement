...
<body>
    ...
    <div class="search-info">
        ...
        <div class="info-row">
            <span class="info-label">Total Results:</span> {{ $totalResults }} teacher(s)
        </div>
        <div class="info-row">
            ...
            <tbody>
                @foreach($teachers as $teacher)
                    <tr>
                        ...
                        <td>{{ $teacher->department ? $teacher->department->fullname : 'N/A' }}</td>
                        <td>{{ $teacher->phone_number }}</td>
                        <td>{{ $teacher->email }}</td>
                        <td>{{ $teacher->gender }}</td>
                        <td>{{ $teacher->date_of_birth ? \Carbon\Carbon::parse($teacher->date_of_birth)->format('Y-m-d') : 'N/A' }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
